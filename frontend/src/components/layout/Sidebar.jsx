...
const icons = {
  dashboard: (
    <svg className="w-5 h-5 mr-3 transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-[10px] mt-1 font-medium tracking-wider uppercase">ERP de Gestión</p>
          </div>
        </div>
      </div>
